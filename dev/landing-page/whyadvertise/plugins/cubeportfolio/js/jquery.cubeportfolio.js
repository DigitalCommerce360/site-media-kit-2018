...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        isImage: function(el) {
            ...
            if ($('<img src="../../../../../../landing-page/whyadvertise/plugins/cubeportfolio/js/' + el.src + '">').is('img:uncached')) {
        ...
        updateSelfHostedVideo: function(src, title, counter) {
            ...
            for (i = 0; i < src.length; i++) {
                if (/(\.mp4)/i.test(src[i])) {
                    markup += '<source src="../../../../../../landing-page/whyadvertise/plugins/cubeportfolio/js/' + src[i] + '" type="video/mp4">';
                } else if (/(\.ogg)|(\.ogv)/i.test(src[i])) {
                    markup += '<source src="../../../../../../landing-page/whyadvertise/plugins/cubeportfolio/js/' + src[i] + '" type="video/ogg">';
                } else if (/(\.webm)/i.test(src[i])) {
                    markup += '<source src="../../../../../../landing-page/whyadvertise/plugins/cubeportfolio/js/' + src[i] + '" type="video/webm">';
                }
            }
        ...
        updateVideoMarkup: function(src, title, counter) {
            ...
            var markup = '<div class="cbp-popup-lightbox-iframe">' +
                '<iframe src="../../../../../../landing-page/whyadvertise/plugins/cubeportfolio/js/' + src + '" frameborder="0" allowfullscreen scrolling="no"></iframe>' +
                '<div class="cbp-popup-lightbox-bottom">' +
                ((title) ? '<div class="cbp-popup-lightbox-title">' + title + '</div>' : '') +
                ((t.options.lightboxShowCounter) ? '<div class="cbp-popup-lightbox-counter">' + counter + '</div>' : '') +
                '</div>' +
        ...
        preloadNearbyImages: function() {
            ...
            for (var i = arr.length - 1; i >= 0; i--) {
                ...
                if (t.dataArray[arr[i]].type === 'isImage') {
                    ...
                    if ($('<img src="../../../../../../landing-page/whyadvertise/plugins/cubeportfolio/js/' + src + '">').is('img:uncached')) {
